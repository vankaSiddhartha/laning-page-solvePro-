...
import { ChevronRight, Brain, Code, Timer, Puzzle, Calculator, Sparkles, Bot, Clock, Check, X,PlayCircle } from "lucide-react"
  ...
  return (
    <div className={cn("relative bg-gray-950 text-white min-h-screen", className)} ref={ref} {...props}>
      ...
      <section className="relative max-w-full mx-auto z-1">
        <RetroGrid />
        <div className="max-w-screen-xl z-10 mx-auto px-4 pt-6 pb-28 gap-12 md:px-8"> {/* Adjusted padding-top */}
